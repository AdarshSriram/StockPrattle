...
class App extends Component {
    constructor(props) {
        super(props);
        this.state = { user: null, type: 'landing', allowedUsers: [ "ic246@cornell.edu", "ac2447@cornell.edu", "adarshsriram10@gmail.com", "alakhotia@college.harvard.edu", "as4532@georgetown.edu", "kshitij@elevationcapital.com"] };
