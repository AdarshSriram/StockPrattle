...
export default class StockGraph extends Component{
    ...
    componentDidMount(){
        getHistory(this.props.title).then(data=>{
            ...
            else this.setState({data: data}, ()=>this.handleData("5d"))
        });
    }
    ...
    buttonPress(e){
        ...
        ReactDOM.unmountComponentAtNode(document.getElementById("stockChartContainer"))
    ...
    render(){
        const comp = (this.state.chartData) ? <StockChart data={this.state.chartData} updateLegend={this.props.updateLegend}/> : null
        return (
